    ...
    <body>
        ...
        <div class="home">
            <div class="slider">
                <div class="list">
                    <div class="item">
                        <img src="{{asset('image/bocchi1.jpg')}}" alt="" />
                    </div>
                    <div class="item">
                        <img src="{{asset('image/bocchi2.jpg')}}" alt="" />
                    </div>
                    <div class="item">
                        <img src="{{asset('image/bocchi3.jpg')}}" alt="" />
                    </div>
                    <div class="item">
                        <img src="{{asset('image/bocchi4.jpg')}}" alt="" />
                    </div>
                    <div class="item">
                        <img src="{{asset('image/bocchi5.jpg')}}" alt="" />
                    </div>
                </div>
                <div class="buttons">
            ...
            <div class="home-wrap">
                ...
                @endphp
                <h2><span>{{$bride_name}}</span> &amp; <span>{{$groom_name}}</span></h2>
