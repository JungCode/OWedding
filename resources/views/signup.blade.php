   ...
   <div class="signup">
    <div class="signup__content">
        ...
        <form class="signup-form" autocomplete="off" method="POST" action="{{ route('users.store') }}">
            @csrf
                <div class="signup-form__group">
                    ...
                    <div class="signup-form__validate">
                        <input type="text" class="signup-form__input" id="name" name="name" required placeholder="Name">
                ...
                <div class="signup-form__group">
                    ...
                    <input type="email" class="signup-form__input" id="email" name="email" required placeholder="Email">
                </div>

            <div class="signup-form__row">
                <div class="signup-form__group">
                    <label for="password" class="signup-form__label">Password</label>
                    <input type="password" class="signup-form__input" id="password" name="password" required placeholder="Password">
                </div>
                <div class="signup-form__group">
                    <label for="password" class="signup-form__label">Confirm Password</label>
                    <input type="password" class="signup-form__input" id="password" name="retype_password" required placeholder="Confirm Password">
                </div>
            </div>           
            ...
            <p class="signup__already">Already signin have an account? <a href="{{ route('login') }}">Sign in</a></p>
        </form>
    </div>
