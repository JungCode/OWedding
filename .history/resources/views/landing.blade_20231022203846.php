      ...
      <div class="headerwrap">
        <div class="header">
          ...
          ?>
            ...
            @else
              <a href="{{ route('login') }}">
                <div class="btnlogined">
                  <button class="Button Buttonlogined" >Đăng nhập</button>
                  <div class="btnlogin_dropdown">
                    <a href="#" class="btnlogin_dropdown-item"></a>
                  </div>
                </div>
              </a>
          @endauth
        ...
        <div class="secondtitle-content_item">
          <div class="itemcontent">
            ...
            <div class="itemcontent_img">
              <img src="https://setlivewallpaper.com/wp-content/uploads/2022/02/Ella-Houkai-Gakuen-2-thumb.jpg" alt="">
            </div>
          </div>
        </div>
    ...
    <div class="lastpage">
      <div class="lastpage_content">
        ...
        <div class="lastpage_content-step">
          <div class="step"><span>1</span><p>TẠO TÀI KHOẢN & ĐĂNG NHẬP VÀO NỀN TẢNG</p></div>
          <div class="step"><span>2</span><p>CHỌN MẪU GIAO DIỆN YÊU THÍCH</p></div>
          <div class="step"><span>3</span><p>TẠO, TUỲ CHỈNH THÔNG TIN & HÌNH ẢNH WEB</p></div>
          <div class="step"><span>4</span><p>CHIA SẺ WEB ĐÁM CƯỚI VỚI MỌI NGƯỜI</p></div>
        </div>
