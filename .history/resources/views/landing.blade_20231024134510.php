...
<body>
    ...
    <div class="secondtitle-content">
      <div class="secondtitle-content_item">
        <div class="itemcontent">
          ...
          <div class="itemcontent_img">
            <img src="{{asset('image\cal.jpg')}}" alt="">
          </div>
        </div>
      </div>
      <div class="secondtitle-content_item s">
        <div class="itemcontent">
          ...
          <div class="itemcontent_img">
            <img src="{{asset('image\money.jpg')}}" alt="">
          </div>
        </div>
      </div>
      <div class="secondtitle-content_item t">
        <div class="itemcontent">
          ...
          <div class="itemcontent_img">
            <img src="{{asset('image\party.jpg')}}" alt="">
          </div>
        </div>
      </div>
      <div class="secondtitle-content_item f">
        <div class="itemcontent">
          ...
          <div class="itemcontent_img">
            <img src="{{asset('image\Letter.jpg')}}" alt="">
          </div>
        </div>
      </div>
  ...
  <div class="thirdpage">
    ...
    <div class="thirdpage_content">
      <div class="item_item">
        <img src="{{asset('image\ser1.jpg')}}" alt="" class="item_image">
      ...
      <div class="item_item">
        <img src="{{asset('image\ser2.jpg')}}" alt="" class="item_image">
        <div class="item_content">
      ...
      <div class="item_item">
        <img src="{{asset('image\ser3.jpg')}}" alt="" class="item_image">
        <div class="item_content">
      ...
      <div class="item_item">
        <img src="{{asset('image\ser4.jpg')}}" alt="" class="item_image">
        <div class="item_content">
      ...
      <div class="item_item">
        <img src="{{asset('image\ser5.jpg')}}" alt="" class="item_image">
        <div class="item_content">
      ...
      <div class="item_item">
        <img src="{{asset('image\ser6.jpg')}}" alt="" class="item_image">
        <div class="item_content">
  ...
  <div class="lastpage">
    ...
    <div class="lastpage_img">
      <img src="{{asset('image\thankspng.jpg')}}" alt="">
    </div>
  </div>
  <!-- finalpage ////////////////////////////////////////-->
  <div class="finalpage">
    <div class="finalpage_content">
      ...
      <div class="finalpage_content-img">
        <img src="https://th.bing.com/th/id/R.086c5d5b5a88a356e6e8d226e25076dc?rik=qLcwkONyJ7OQDA&riu=http%3a%2f%2felariophotography.com%2fwp-content%2fuploads%2f2016%2f09%2fsagamore_wedding_photos-29.jpg&ehk=txVFWu8JOU%2fsLHbkNaJMIpKsYtICS%2ba%2bClH%2bdpKElrE%3d&risl=&pid=ImgRaw&r=0" alt="" class="finalpage_content-img-item">
        <img src="https://cajphotography335.zenfolio.com/img/s/v-10/p2450054690-4.jpg" alt="" class="finalpage_content-img-item">
        <img src="https://cajphotography335.zenfolio.com/img/s/v-10/p2450047733-4.jpg" alt="" class="finalpage_content-img-item">
        <img src="https://th.bing.com/th/id/OIP.zVJGmUeZpS__l9ahNOGkrAHaE8?pid=ImgDet&w=1500&h=1001&rs=1" alt="" class="finalpage_content-img-item">
        <img src="https://www.lindabeansperfectmaine.com/wp-content/uploads/2014/12/GP302-580x385.jpg" alt="" class="finalpage_content-img-item">
        <img src="https://i.pinimg.com/originals/be/dd/06/bedd0625abb8a06454e286a6598e2f38.jpg" alt="" class="finalpage_content-img-item">
