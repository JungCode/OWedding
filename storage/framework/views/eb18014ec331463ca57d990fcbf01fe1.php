...
<?php $__env->startSection('content'); ?>
        ...
        <section class="rounded-b-3xl border border-solid border-slate-300 mb-11 overflow-hidden py-5 px-9 shadow-xl">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <select name="" id="selector5"
                        ...
                        <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($event->name); ?>"><?php echo e($event->name); ?></option>
            ...
            <div class="mb-2">
                <div class="inline-block mr-4">
                    ...
                    Tổng số khách mời: <?php echo e($totalGuest); ?>

                </div>
                <div class="inline-block mr-4">
                    <i class="fa-solid fa-circle text-indigo-700"></i>
                    Tham gia: <?php echo e($comingGuest); ?>

                </div>
                <div class="inline-block mr-4">
                    <i class="fa-solid fa-circle text-pink-700"></i>
                    Không tham gia: <?php echo e($notComingGuest); ?>

                </div>
                <div class="inline-block mr-4">
                    <i class="fa-solid fa-circle text-slate-500"></i>
                    Không xác nhận: <?php echo e($notConfirmGuest); ?>

                </div>
                <div class="inline-block mr-4">
                    <i class="fa-solid fa-circle text-green-wedding"></i>
                    Tiền mừng: <?php echo e($totalWeddingMoney); ?>đ
                </div>
            </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $guests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b-2 border-solid border-slate-300 bg-slate-100 text-2xl ">
                                ...
                                <td class="border-r-2 border-solid border-gray-100 text-center py-5 px-3">
                                    <?php echo e($guest['name']); ?></td>
                                <td class="border-r-2 border-solid border-gray-100 text-center py-5 px-3">
                                    <?php echo e($guest['phone_number']); ?></td>
                                <td class="border-r-2 border-solid border-gray-100 text-center py-5 px-3">
                                    <div class="bg-slate-500 rounded-lg text-white font-bold">
                                        <?php echo e($guest['event']); ?>
                                ...
                                <td class="border-r-2 border-solid border-gray-100 text-center py-5 px-3">
                                    <div class="bg-purple-wedding rounded-lg text-white font-bold">
                                        <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($guest['group_id'] == $group['id']): ?>
                                ...
                                <td class="border-r-2 border-solid border-gray-100 text-center py-5 px-3">
                                    <?php echo e($guest['confirmation']); ?></td>
                                <td class="border-r-2 border-solid border-gray-100 text-center py-5 px-3">
                                    <?php echo e($guest['go_with']); ?>

                                    <i class="fa-solid fa-user text-gray-400"></i>
                                </td>
                                <td class="border-r-2 border-solid border-gray-100 text-center py-5 px-3">
                                    <i class="fa-solid fa-sack-dollar text-gray-400"></i>
                                    <?php echo e($guest['wedding_money']); ?>

                                </td>
                                <td class="text-center">
                                    <button class="mr-3 transition hover:text-slate-500 show-guest-adding-modal"
                                        data-event="<?php echo e($guest['event']); ?>" data-email="<?php echo e($guest['wedding_money']); ?>"
                                        data-guestid="<?php echo e($guest['id']); ?>" data-guestname="<?php echo e($guest['name']); ?>"
                                        data-phone="<?php echo e($guest['phone_number']); ?>"
                                        data-groupguest="<?php echo e($guest['group_id']); ?>"
                                        data-gowith="<?php echo e($guest['go_with']); ?>">
    ...
    <div
        ...
        <div class=" bg-white rounded-lg shadow-lg w-1/3">
            ...
            <div class="px-7 bg-slate-200">
                <form id="" method="POST" action="<?php echo e(route('guestGroups.store')); ?>"
                    ...
                    <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border border-solid border-slate-300 rowedit">
                            ...
                            <td class="border border-solid border-slate-300 py-4 px-4 text-left w-8/12"
                                id="<?php echo e('adu' . $loop->iteration); ?>">
                                <?php
                                $groupid = $group['id'];
                                ?>
                                <form id="" method="POST"
                                    action="<?php echo e(route('guestGroups.update', $groupid)); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <input name="group_name" class="w-8/12 input" type="text"
                                        value="<?php echo e($group['group_name']); ?>" readonly>
                                    <button
                            ...
                            <td class=" flex justify-center items-center py-4 px-4">
                                <button class="inline-block transition hover:text-slate-500 editbtn"
                                    id="<?php echo e('adu' . $loop->iteration); ?>"><i class="fa-solid fa-pen mr-4"></i></button>
    ...
    <script src="<?php echo e(asset('guest-tool/js.js')); ?>"></script>
    <script>
        // adding-modal
        ...
        showGuestAddingModal.forEach(function(element) {
            element.addEventListener('click', function() {
                ...
                if (guestId == '') {
                    ...
                    form.setAttribute('action', `<?php echo e(route('guest.store')); ?>`);
                    btnSubmit.innerHTML = "<i class=\"fa-solid fa-plus\"></i> Thêm mới";
                } else {
                    methodField.setAttribute('value', 'PUT');
                    form.setAttribute('action', `<?php echo e(route('guest.update', ':guestID')); ?>`.replace(
                        ':guestID',
                        guestId));
...
<?php echo $__env->make('layouts.toolweb.tools', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\trung\oWedding-project\resources\views/guest/guest.blade.php ENDPATH**/ ?>