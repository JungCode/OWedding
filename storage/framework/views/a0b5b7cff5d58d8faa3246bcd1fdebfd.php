   ...
   <div class="signup">
    <div class="signup__content">
        ...
        <form class="signup-form" autocomplete="off" method="POST" action="<?php echo e(route('users.login')); ?>">
            ...
            <p class="signup__already">Don't have an account? <a href="<?php echo e(route('users.create')); ?>"> Register here!</a></p>
        </form>
    </div>
...
</html><?php /**PATH D:\oWeddinggit\OWedding\resources\views/signin.blade.php ENDPATH**/ ?>