...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="<?php echo e(asset('404page/reset.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('404page/style.css')); ?>" />
  </head>
  <body>
    <div class="errorpage">
      <h1 class="errorpage-title">Oopps!</h1>
      <div class="errorpage-img">
        <img src="<?php echo e(asset('404page/coding.png')); ?>" alt="" />
      </div>
      ...
      <div class="errorpage-button">
        <button class="Button"><a href="<?php echo e(route('users.index')); ?>">VỀ TRANG CHỦ</a></button>
      </div>
    </div>
  </body>
</html>
<?php /**PATH C:\Users\trung\oWedding-project\resources\views/404.blade.php ENDPATH**/ ?>