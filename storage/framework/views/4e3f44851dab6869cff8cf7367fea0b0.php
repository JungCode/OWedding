...
<body>
    <div class="header">
        <a class="header_logo" href="/">
            <img class="logo-white logoactive" width="229" height="93" src="<?php echo e(asset('image/Picture1.png')); ?>" />
        ...
        <div class="slider">
            <div class="list">
                <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="item">
                        <img src="<?php echo e(asset('storage/' . $slide->photo)); ?>" alt="" />
                    </div>
                ...
                <?php if($events): ?>
                    <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="event-item">
                            <h3 class="event-item_title"><?php echo e($event->name); ?></h3>
                            <div class="event-item_content">
                                <div class="event-item_img">
                                    <img src="<?php echo e(asset('storage/' . $event->photo)); ?>" alt="">
                                </div>
                                <div class="event-item_main">
                                    ...
                                    <div class="link">
                                        <a href="<?php echo e($event->link); ?>" target="_blank">Xem bản đồ</a>
...
<?php /**PATH C:\Users\trung\oWedding-project\resources\views/template-choice/template/template1.blade.php ENDPATH**/ ?>