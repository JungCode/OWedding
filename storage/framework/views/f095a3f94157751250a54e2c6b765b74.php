...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="signup__already">Already signin have an account? <a href="<?php echo e(route('users.showlogin')); ?>">Login</a></p>
            </form>
        </div>
...
<?php /**PATH C:\Users\trung\oWedding-project\resources\views/user/signup.blade.php ENDPATH**/ ?>