...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('template/template1/reset.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('template/template1/style.css')); ?>" />
    </head>
    <body>
        <div class="header">
            <a class="header_logo" href="/">
                <img
                    class="logo-white logoactive"
                    width="229"
                    height="93"
                ...
                <img
                    ...
                    width="229"
                    height="93"
                    src="<?php echo e(asset('image/Picture2.png')); ?>"
                />
            </a>
        ...
        <div class="home">
            <div class="slider">
                <div class="list">
                    <div class="item">
                        <img src="<?php echo e(asset('image/bocchi1.jpg')); ?>" alt="" />
                    </div>
                    <div class="item">
                        <img src="<?php echo e(asset('image/bocchi2.jpg')); ?>" alt="" />
                    </div>
                    <div class="item">
                        <img src="<?php echo e(asset('image/bocchi3.jpg')); ?>" alt="" />
                    </div>
                    <div class="item">
                        <img src="<?php echo e(asset('image/bocchi4.jpg')); ?>" alt="" />
                    </div>
                    <div class="item">
                        <img src="<?php echo e(asset('image/bocchi5.jpg')); ?>" alt="" />
                    </div>
                </div>
                <div class="buttons">
            ...
            <div class="home-wrap">
                ...
                <?php
                    $bride_name = ($bride_name) ? $bride_name : "trung bui";
                    $groom_name = ($groom_name) ? $groom_name : "Asuna";
                    $wedding_date = ($wedding_date) ? $wedding_date : "2023-5-11";
                    $bride_description = ($bride_description) ? $bride_description : "mình học bách khoa cơ khí, sinh năm 2k4. Tự mày mò\n"
                    ...
                    $groom_description = ($groom_description) ? $groom_description : "Asuna là một cô nàng nhỏ nhắn và xinh đẹp. Cô sở hữu\n"
                ...
                ?>
                <h2><span><?php echo e($bride_name); ?></span> &amp; <span><?php echo e($groom_name); ?></span></h2>
        ...
        <div class="couple">
            ...
            <div class="couple-content">
                ...
                <div class="couple-content_male">
                    <div class="couple-text">
                        <div class="couple-text_top">
                            ...
                            <span><?php echo e($bride_name); ?></span>
                        </div>
                        <div class="couple-text_bottom">
                            <?php echo e($bride_description); ?>
                ...
                <div class="couple-content_female">
                    ...
                    <div class="couple-text">
                        <div class="couple-text_top">
                            <span><?php echo e($groom_name); ?></span>
                            <div class="couple-text_top__icon">
                                <a href="">
                                    <i class="fa-brands fa-facebook-f"></i>
                                </a>
                    ...
                    <div class="event-item">
                        ...
                        <div class="event-item_content">
                            <div class="event-item_img">
                                <img src="/public/image/wedd3.jpg" alt="">
                            </div>
                            <div class="event-item_main">
                                <div class="datetime">
                                    <div class="eventday"><i class="fa-regular fa-calendar-check"></i><span>2023-02-10</span></div>
                                    <div class="eventtime"><i class="fa-regular fa-clock"></i><span>11:30 AM</span></div>
                                </div>
                                <div class="address">
                                    <i class="fa-solid fa-location-dot"></i><p> 187 Hà Huy Tập, P. Hoà Khê, Quận Thanh Khê, Đà Nẵng</p>
                                </div>
                                <div class="link">
                                    <a href="#">Xem bản đồ</a>
        ...
        <script src="<?php echo e(asset('template/template1/js.js')); ?>"></script>
    </body>
</html>
<?php /**PATH D:\oWeddinggit\OWedding\resources\views/template-choice/template/template1.blade.php ENDPATH**/ ?>