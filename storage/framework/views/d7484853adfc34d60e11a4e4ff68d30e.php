        ...
        showEventModal.forEach(function(element) {
            element.addEventListener('click', function() {
                ...
                if (eventId == '') {
                    ...
                    form.setAttribute('action', `<?php echo e(route('tasks.update', ':eventID')); ?>`.replace(
                        ':eventID',
                        eventId));
...
<?php echo $__env->make('layouts.toolweb.tools', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\trung\oWedding-project\resources\views/wedding-event/event.blade.php ENDPATH**/ ?>