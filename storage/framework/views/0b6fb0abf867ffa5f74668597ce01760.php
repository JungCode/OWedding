      ...
      <div class="header">
        ...
        <form action="<?php echo e(route('users.logout')); ?>" method="POST">
          ...
          <div class="userbutton">
            <button class="Button"><?php echo e($user['name']); ?> <i class="fa fa-user-circle" aria-hidden="true"></i></button>
        ...
        <?php else: ?>
        <a href="<?php echo e(route('users.showlogin')); ?>">
          <div class="userbutton">
...
</html><?php /**PATH C:\Users\trung\oWedding-project\resources\views/landing.blade.php ENDPATH**/ ?>