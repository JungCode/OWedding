    ...
    <div style="width: 80%">
        ...
        <form action="<?php echo e(route('fiances.update', 11)); ?>" method="POST" enctype="multipart/form-data"
            ...
            <div class="border border-soli  d border-slate-300 p-5 rounded-2xl shadow-2xl mb-32">
                ...
                <div class="input-focus-effect">
                    <textarea name="bride_description" id="" class="h-52" required><?php echo e($bride->description); ?></textarea>
            ...
            <div class="border border-solid border-slate-300 p-5 rounded-2xl shadow-2xl mb-32">
                ...
                <div class="input-focus-effect">
                    <textarea name="groom_description" id="" class="h-52" required><?php echo e($groom->description); ?></textarea>
                    <label>Giới thiệu</label>
                </div>
            </div>
...
<?php echo $__env->make('layouts.toolweb.tools', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\oWeddinggit\OWedding\resources\views/wedding-fiance/fiance.blade.php ENDPATH**/ ?>