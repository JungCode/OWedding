    ...
    <body>
        ...
        <div class="profile">
            <div class="profile-content">
                ...
                <form class="profile-content_infor" enctype="multipart/form-data" method="POST" action="<?php echo e(route('users.update',$user['id'])); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="profile_form">
                        ...
                        <div class="form-row">
                            <div class="input-focus-effect">
                                <input name="birthday" type="date" data-date="yyyy-mm-dd" data-date-format="YYYY-MM-DD" min="1943-11-01" max="2023-11-01" aria-required="true" value="<?php echo e($user['birthday']); ?>">
                                <label>Birtday</label>
                            </div>
                            <div class="input-focus-effect">
...
<?php /**PATH D:\oWeddinggit\OWedding\resources\views/user/profile.blade.php ENDPATH**/ ?>